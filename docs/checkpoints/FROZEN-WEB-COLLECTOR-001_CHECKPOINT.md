...
Mode: IMPLEMENT
Lifecycle state: VERIFY — Collector 1.0.8 live; production save verification requested
Status: ETag transport repair tested and live; separate GitHub acceptance job requested
