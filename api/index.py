...
2.2.7 keeps the 2.2.6 region-shared recurrent cursor and adds an authenticated
speculative draft-prefill bridge. Unsent composer text may be prefilled into a cloned
R39 cursor; final send remains authoritative and exact-prefix validates before reuse.
Chat live-source assets remain independent from the base deployment.
"""
