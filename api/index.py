...
Server 2.3.303 makes the Workstation queue the generation-lifetime authority: Chat submits a durable turn and may disconnect while R39 continues independently.
"""
