...
_server.CAPABILITIES["runtime-delivery-optimization"] = {"kind":"performance","ready":True,"contract":"prepared-runtime-generation-v3","requestPathSync":False,"explicitHotActivation":True,"assetCacheContract":"manifest-versioned-immutable-v1","detail":"Legacy Chat and LALM consume an accepted generation prepared before production deployment; later runtime-hot changes require explicit activation and ordinary Chat requests never synchronize repository state."}
