...
def install(server):
    ...
    async def auth_config():
        return JSONResponse({"googleClientId": os.getenv("GOOGLE_OAUTH_CLIENT_ID", ""), "persistentStore": bool(os.getenv("KV_REST_API_URL") or os.getenv("UPSTASH_REDIS_REST_URL")), "accountContract": "swrlz-user-account-v1", "chatClientOverlay": "1.3.31"}, headers={"Cache-Control": "no-store"})
