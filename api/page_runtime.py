...
def install(server) -> None:
    ...
    server.CAPABILITIES["live-page-runtime"] = {"kind": "runtime-mutation", "ready": True, "sourceBranch": DEFAULT_BRANCH, "manager": "/api/pages", "deployOnRuntime": False}
    ...
    async def page_action(request: Request, action: str = Query(...), key: str = Query(default="")):
        ...
        try:
            ...
            if action == "sync":
                ...
                return {"ok": True, "branch": branch, "files": fetched, "backupId": backup_id, "note": "runtime branch sync does not trigger Vercel deployment"}
