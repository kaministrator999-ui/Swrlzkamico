"""Hot R39 entrypoint — v29 shared speculative draft-prefill overlay."""
from __future__ import annotations

import urllib.request

_SOURCE_URL = "https://raw.githubusercontent.com/kaministrator999-ui/Swrlzkamico/dev/runtime_hot/r39_engine_v29.py"
...
if len(_source) > 4_000_000:
    raise RuntimeError("R39_V29_OVERLAY_TOO_LARGE")
