...
- **Side-menu control / opening stage scenery:** SOURCE-INTEGRATED as 1.0.10 — compact fixed top-left glass menu button with a hamburger glyph, safe-area-aware placement, and accessibility semantics. Button is scenery/control affordance only; drawer opening behavior and side-menu contents are not yet admitted.
