...
static PyMethodDef Methods[]={{"matmat",py_matmat,METH_VARARGS,"Direct quantized matrix-matrix multiply for batched prefill."},{NULL,NULL,0,NULL}};
static struct PyModuleDef Module={PyModuleDef_HEAD_INIT,"_r39_batch","Native direct-quantized R39 batched prefill kernels",-1,Methods};
PyMODINIT_FUNC PyInit__r39_batch(void){import_array();return PyModule_Create(&Module);}
