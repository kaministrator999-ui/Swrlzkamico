...
const DEFAULT_NAME_BY_LANG={cpp:'main.cpp',cxx:'main.cpp','c++':'main.cpp',c:'main.c',h:'main.h',hpp:'main.hpp',html:'index.html',css:'styles.css',javascript:'script.js',js:'script.js',typescript:'app.ts',ts:'app.ts',jsx:'App.jsx',tsx:'App.tsx',python:'main.py',py:'main.py',java:'Main.java',kotlin:'Main.kt',kt:'Main.kt',json:'data.json',yaml:'config.yaml',yml:'config.yml',markdown:'README.md',md:'README.md',bash:'script.sh',shell:'script.sh',sh:'script.sh',powershell:'ps1',sql:'query.sql',go:'main.go',rust:'main.rs',rs:'main.rs',swift:'swift',ruby:'rb',rb:'rb',php:'index.php'};
